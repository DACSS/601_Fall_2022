...
Using the mentioned functions allowed to extract important details about guest demographics provided enough information for us to infer the hotel group is in Portugal. After viewing the relationship between country and children, we can see that for countries with over 1000 bookings, Portugal is not in the top ten of mean child guests; is our hotel group a business brand or a family friendly destination?

...
Construct a graph that shows the observed values of the MMR plotted against year (starting in 2000) for India and Thailand.Use the pipe operator so that the graph follows from a multi-line command that starts with “mmr %>%”.Use ggplot() to display the data.
```{r}

...
- `house_product`: Boolean which states whether a product is 3rd Party or not
- `isCannabis`: Boolean which states whether a product is cannabis or non-cannabis

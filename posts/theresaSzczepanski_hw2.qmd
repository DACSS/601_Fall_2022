...
MCAS_2022<-read_csv("_data/Spring2022_MCAS_full_preliminary_results_04830305.csv")%>%
  select(-c("sprp_dis", "sprp_sch", "sprp_dis_name", "sprp_sch_name", "sprp_orgtype",
  "schtype", "testschoolname", "lastname", "firstname", "mi", "yrsindis", "conenr_dis"))%>%
...
- *Key assessment features* subject, test format, 

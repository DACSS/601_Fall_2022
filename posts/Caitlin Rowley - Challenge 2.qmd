...
knitr::opts_knit$set(root.dir = "C://Users//caitr//OneDrive//Documents//DACSS//601_Fall_2022//posts//_data")
```
...
railroad <- read_csv("C:\\Users\\caitr\\OneDrive\\Documents\\DACSS\\601_Fall_2022\\posts\\_data\\railroad_2012_clean_county.csv")
railroad
...
# I also want to gather some basic descriptive statistics of this data set, including (1) the ten counties with the lowest number of railroad employees and (2) the ten counties with the highest number of railroad employees. I will do this by slicing the data:
...
# I would like to know how many unique county names there are in this data set. I will use the select() function:
...
# I would now like to group this data by state/territory to identify which states have the highest TOTAL number of railroad employees. For this, I will use the group_by() and summary() functions:
...
>>>>>>> bc3b82e29c8901239d5ed1ca750a5aa837431cd5

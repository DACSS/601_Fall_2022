...
I could not think of any reason why I would pivot my data so I did the below to show it could be pivoted.

```{r}

mutatedData %>% pivot_longer(c(MedianIncome_est,MedianIncome_MOE), names_to = "Metric",values_to = "Values")

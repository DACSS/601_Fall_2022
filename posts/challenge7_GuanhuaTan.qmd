...
# violin graphic
pisa2018_case_study_clean %>%
  ggplot(aes(CNT,Evaluation, fill=CNT), na.rm=T) +geom_violin()+facet_wrap(~Group)+xlab("Country")+ylab("Evaluation")+ggtitle("Schools' Evaluation on Digtial Device") 

...
After the text was cleaned, the frequency of 6 instances was uset as the minimum parameter for what would appear in the word cloud. This was a subjective decision based on observation of several options, and this seemed the clearest and most helpful view of the data. The resulting word cloud is below.
```{r}

...
#   ggplot(aes(fill=key_word, y = `sitem Possible Points`, x=`sRepporting Category`)) + 
#     geom_bar(position="stack", stat="identity")+
#   labs(subtitle = "Stacked Bar Chart",
#        y = "Available Points",
#        x= "Reporting Category",
#        title = "Avialable points by Key Word",
#       caption = "2022 HS Introductory Physics MCAS")+
#        theme(axis.text.x=element_text(angle=60,hjust=1))
#   coord_flip()
...
G9Science_Calc_Box
```
As we can see, that a student's performance on their 8th Grade Math MCAS is strongly associcated with their performance on the Introductory Physics exam.
```{r}

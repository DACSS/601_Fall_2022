...
```
Since Motion and Forces questions account for 50% of the points available on the test, our students "lost" in total the most points relative to the state in this category.

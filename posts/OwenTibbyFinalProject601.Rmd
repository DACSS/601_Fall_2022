...
# # #RStudio Desktop
carprices <- read_csv("_data/car_prices.csv", col_types = cols(mmr = col_number(), year = col_character(), sellingprice = col_number(), ...17 = col_skip()))
df <- carprices
exchange_rate <- read_excel("_data/HistoricalPrices.xlsx", col_types = c("numeric", "text", "skip", "skip", "skip", "numeric"))

#Second Read-In of ca_catalog (to make data fields private)
ca_catalog <- read_csv("_data/ca_catalog.csv")

#Read-In from code chunk
decoded_keys <- read_csv("_data/decoded.keys.csv")
```
...
# decoded_keys <- read_csv("/cloud/project/Final_project/decoded.keys.csv")
```

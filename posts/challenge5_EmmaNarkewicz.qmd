...
I wanted to create a bubble map based on prices, but continued to get errors that the subscript was out of bounds when trying to load a map of New York & New Jersey in the background as modeled on [R Graph Gallery](https://r-graph-gallery.com/). This is something I hope to be able to accomplish later, perhaps with some guidance from the course tutors.

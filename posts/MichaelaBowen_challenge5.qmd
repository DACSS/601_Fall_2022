...
#| message: false
#Read in Excel Data
transactions_9_22_2022_10_5_2022_orig <- read_excel("_data/Inventory Transactions 9_22_2022-10_5_2022.xlsx", 
    skip = 5,
...
transactions_9_22_2022_10_5_2022 <- transactions_9_22_2022_10_5_2022_orig%>%
...
#| warning: false
#| message: false
print(summarytools::dfSummary(transactions_9_22_2022_10_5_2022,
                        varnumbers = FALSE,
                        plain.ascii  = FALSE, 
                        style        = "grid", 
                        graph.magnif = 0.70, 
...
ggplot(data = transactions_9_22_2022_10_5_2022, mapping = aes(category_names, fill = category_names), size = 1) +
  geom_bar() +
  ylim(0, NA) +
...
sold_by_price <- transactions_9_22_2022_10_5_2022%>%
  group_by(product)%>%
  mutate(avg_price = mean(price))%>%
  mutate(products_sold = sum(qty_sold))%>%
  select(-qty_sold)%>%
  distinct()%>%

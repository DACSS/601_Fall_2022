...
```{r}
 ...
 ggplot(SG9_Cat_Total, aes(x= `Reporting Category`, fill = `Reporting Category`))+
  geom_bar( alpha=0.9) +
...
SG9_Cat_MeanStateDiff<-SG9_Cat_StateDiff%>%

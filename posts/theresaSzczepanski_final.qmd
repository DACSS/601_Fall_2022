...
In this report, I will analyze the Spring 2022 MCAS Results for students completing the Highschool Introductory Physics MCAS at [Rising Tide Charter Public School](https://risingtide.org/).
...
###Mutate, Science and Math to Include Grade Level and then join?
...
# view(MG5_Item)
# MG6_Item<-read_item("MG6", "math", 6)
# view(MG6_Item)
# MG7_Item<-read_item("MG7", "math", 7)
# view(MG7_Item)
# MG8_Item<-(read_item("MG8", "math", 8))
#  view(MG8_Item)
# MG10_Item<-(read_item("MG10", "math", 10))
# view(MG10_Item)
...
```{r}
G9Science_StudentItem <- SG9_MCAS_2022 %>%
...
```{r}
#view(SG9_Item)
G9Science_Cat_StateDiff<-SG9_Item%>%

...
I used the Olympics dataset previously for the Homework 2 and I will be using the same content for the sections Read in data, Tidy data and mutate variables (as needed).

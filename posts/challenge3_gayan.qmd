...
There are 9 locations around the world and 16 animals. so when pivoted we should expect 144 rows in the new table. 


## Pivot the Data

```{r}
animal_weight_long <-pivot_longer(animal_weight, col = -`IPCC Area`,

...
The dataset being used is a pre-existing one originally picked from https://layoffs.fyi/ taken till 12/29/22. It gives details of all the layoffs that have happened since March 2020 when the pandemic hit. It contains 1696 mass layoff details which have taken place in 161 cities of 55 countries and affecting 28 industries since March 2020. 
